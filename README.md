...
* **Pagination:** While pagination is applied in the Backend, UI pagination was not applied due to time constraints and overall unfamiliarity. V2 will definitely look into adding simple pag navigations.
