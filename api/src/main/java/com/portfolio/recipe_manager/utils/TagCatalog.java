...
public class TagCatalog {
    ...
    public static final Map<String, List<String>> INGREDIENT_TAGS = Map.of(
            ...
            "Pasta", List.of("spaghetti", "macaroni", "fettuccine"),
    ...
    public static final Map<String, List<String>> INSTRUCTION_TAGS = Map.of(
            "Baked", List.of("bake", "preheat", "oven", "knead", "dough"),
            ...
            "Soup", List.of("soup", "broth", "stock", "simmer", "chowder", "stew", "bouillon", "ladle", "boil")
    );
}
